...
public class GraduationResultDto {
    ...
    public GraduationResultDto(boolean graduated,CreditStatusDto creditStatus, boolean englishPassed, boolean coursedPassed, List<GraduationRequirementsCourses> remainingCourses, List<CoreType> remainingCoreTypes) {
